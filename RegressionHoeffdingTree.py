...
class Node:
    ...
    def update_root(self):
        if isinstance(self.parent,RegressionHoeffdingTree):
            self.isroot = True
        else:
            self.isroot = False
...
class LeafNode(Node):
    """
    LeafNode-Object for RegressionHoeffdingTree
    """
...
class LinearRegressor:
    """
    A perceptron for RegressionHoeffdingTree
    """
